...
I'm Blessing a high school student and open sourceror passionate about software engineering, science, blogging and music. From the moment I produced "Hello world" in the console of my first application, I knew I was hooked into the world of software engineering. But software engineering has never been "just a job" for me, it's offered me an engaging challenge to continually learn and improve my skills in creating high quality software. What started with a simple "Hello world" has become a full-fledged passion that only gets exciting as the years go by.
